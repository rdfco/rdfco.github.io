...
function copyLegacyRuntime() {
  return {
    ...
    async closeBundle() {
      ...
      const bundledCustomizerPath = '/site-customizer.bundle.js?v=compact-header-20260828-1'
      const bundledStylesPath = '/custom.bundle.css?v=compact-header-20260828-1'
