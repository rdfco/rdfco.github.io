...
function copyLegacyRuntime() {
  return {
    ...
    async closeBundle() {
      ...
      const bundledCustomizerPath = '/site-customizer.bundle.js?v=webgl-lifecycle-20260828-1'
      const bundledStylesPath = '/custom.bundle.css?v=webgl-lifecycle-20260828-1'
