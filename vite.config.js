...
function copyLegacyRuntime() {
  return {
    ...
    async closeBundle() {
      ...
      const bundledCustomizerPath = '/site-customizer.bundle.js?v=responsive-scroll-20260828-1'
      const bundledStylesPath = '/custom.bundle.css?v=responsive-scroll-20260828-1'
